...
public class GluteBridge {
    ...
    private int repetitions; // Number of glute bridge repetitions
    ...
    @Column(name = "label")
    private String label; // Label for the exercise type, e.g., "Single Leg Glute Bridge"
    ...
    public GluteBridge(User user, int repetitions, double averageScore, Date exerciseDate, String label, String comment) {
        this.user = user;

...
public class FlutterKicks {
    ...
    private int durationSeconds; // Duration of the flutter kicks in seconds
    ...
    @Column(name = "label")
    private String label; // Label for the exercise type, e.g., "Standard Flutter Kicks"
    ...
    public FlutterKicks(User user, int durationSeconds, double averageScore, Date exerciseDate, String label, String comment) {
        this.user = user;

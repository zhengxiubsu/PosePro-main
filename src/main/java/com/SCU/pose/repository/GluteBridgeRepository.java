...
import com.SCU.pose.model.GluteBridge;
...
@Repository
public interface GluteBridgeRepository extends JpaRepository<GluteBridge, Integer> {
    List<GluteBridge> findByUserId(int userId);
